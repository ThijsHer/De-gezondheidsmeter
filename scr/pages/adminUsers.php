...
if (isset($_GET['search'])) {
    $data = $controller->getUsersByName($_GET['search']);
} else {
    $data = $controller->getAllUsers();
}

if (isset($_POST['delete'])) {
    if($controller->deleteUserById($_POST['id'])) {
...
if (isset($_POST['save'])) {
    if($controller->updateUserById($_POST['id'], $_POST['newPassword'],$_POST['admin'],$_POST['blocked'])) {
